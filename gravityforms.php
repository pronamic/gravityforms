...
if ( ! defined( 'GRAVITY_FORMS_GRAVITY_FORMS_WP_MCP_AUTOLOAD' ) ) {
	/**
	 * Whether to autoload the Gravity Forms MCP adapter.
	 *
	 * @var boolean GRAVITY_FORMS_GRAVITY_FORMS_WP_MCP_AUTOLOAD Whether to autoload the Gravity Forms MCP adapter.
	 */
	define( 'GRAVITY_FORMS_GRAVITY_FORMS_WP_MCP_AUTOLOAD', false );
}

/**
 * Run the vendor-prefixed autoloader generated by Strauss.
 */
require_once GF_PLUGIN_DIR_PATH . '/vendor-prefixed/autoload.php';
...
class GFForms {
	...
	*/
	public static function get_service_container() {
		$mcp_adapter_path = GF_PLUGIN_DIR_PATH . '/vendor-prefixed/wordpress/mcp-adapter/mcp-adapter.php';
