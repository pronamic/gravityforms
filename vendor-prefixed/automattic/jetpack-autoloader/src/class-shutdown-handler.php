 ...
 */
class Gravity_Forms_Gravity_Forms_Shutdown_Handler {
	 ...
	 * Constructor.
	 *
	 * @param Gravity_Forms_Gravity_Forms_Plugins_Handler $plugins_handler The Gravity_Forms_Gravity_Forms_Plugins_Handler instance to use.
