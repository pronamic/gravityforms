 ...
 */
class Gravity_Forms_Gravity_Forms_Plugin_Locator {
	 ...
	 * The constructor.
	 *
	 * @param Gravity_Forms_Gravity_Forms_Path_Processor $path_processor The Gravity_Forms_Gravity_Forms_Path_Processor instance.
	 */
