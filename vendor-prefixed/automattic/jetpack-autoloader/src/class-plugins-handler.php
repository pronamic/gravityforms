 ...
 */
class Gravity_Forms_Gravity_Forms_Plugins_Handler {
	/**
	 ...
	 *
	 * @var Gravity_Forms_Gravity_Forms_Plugin_Locator
	 */
	 ...
	 *
	 * @var Gravity_Forms_Gravity_Forms_Path_Processor
	 */
	 ...
	 * The constructor.
	 *
	 * @param Gravity_Forms_Gravity_Forms_Plugin_Locator $plugin_locator The locator for finding active plugins.
	 * @param Gravity_Forms_Gravity_Forms_Path_Processor $path_processor The processor for transforming cached paths.
	 */
