...
class GetPromptResult extends Result implements ServerResultInterface
{
     ...
     * @since 2024-11-05
     *
     * @var array<\Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Prompts\DTO\PromptMessage>
     */
    protected array $messages;

    /**
     * @param array<\Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Prompts\DTO\PromptMessage> $messages @since 2024-11-05
     ...
     *     messages: array<array<string, mixed>|\Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Prompts\DTO\PromptMessage>
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var array<\Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Prompts\DTO\PromptMessage> $messages */
        $messages = array_map(
    ...
    /**
     * @return array<\Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Prompts\DTO\PromptMessage>
     */
