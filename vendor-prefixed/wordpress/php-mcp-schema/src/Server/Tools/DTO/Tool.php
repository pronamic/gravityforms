...
namespace Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Tools\DTO;

use Gravity_Forms\Gravity_Forms\WP\McpSchema\Common\Core\DTO\Icon;
use Gravity_Forms\Gravity_Forms\WP\McpSchema\Common\Protocol\DTO\BaseMetadata;
...
class Tool extends BaseMetadata
{
     ...
     * @since 2024-11-05
     *
     * @var \Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Tools\DTO\ToolInputSchema
     */
     ...
     * @since 2025-11-25
     *
     * @var \Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Tools\DTO\ToolExecution|null
     */
     ...
     * @since 2025-06-18
     *
     * @var \Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Tools\DTO\ToolOutputSchema|null
     */
     ...
     * @since 2025-03-26
     *
     * @var \Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Tools\DTO\ToolAnnotations|null
     */
     ...
     * @param \Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Tools\DTO\ToolInputSchema $inputSchema @since 2024-11-05
     * @param string|null $title @since 2025-06-18
     * @param string|null $description @since 2024-11-05
     * @param \Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Tools\DTO\ToolExecution|null $execution @since 2025-11-25
     * @param \Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Tools\DTO\ToolOutputSchema|null $outputSchema @since 2025-06-18
     * @param \Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Tools\DTO\ToolAnnotations|null $annotations @since 2025-03-26
     ...
     *     inputSchema: array<string, mixed>|\Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Tools\DTO\ToolInputSchema,
     *     execution?: array<string, mixed>|\Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Tools\DTO\ToolExecution|null,
     *     outputSchema?: array<string, mixed>|\Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Tools\DTO\ToolOutputSchema|null,
     *     annotations?: array<string, mixed>|\Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Tools\DTO\ToolAnnotations|null,
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Tools\DTO\ToolInputSchema $inputSchema */
        $inputSchema = is_array($data['inputSchema'])
            ? ToolInputSchema::fromArray(self::asArray($data['inputSchema']))
            : $data['inputSchema'];

        /** @var \Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Tools\DTO\ToolExecution|null $execution */
        ...
        /** @var \Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Tools\DTO\ToolOutputSchema|null $outputSchema */
        ...
        /** @var \Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Tools\DTO\ToolAnnotations|null $annotations */
    ...
    /**
     * @return \Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Tools\DTO\ToolInputSchema
     */
    ...
    /**
     * @return \Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Tools\DTO\ToolExecution|null
     */
    ...
    /**
     * @return \Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Tools\DTO\ToolOutputSchema|null
     */
    ...
    /**
     * @return \Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Tools\DTO\ToolAnnotations|null
     */
