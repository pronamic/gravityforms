...
class ElicitationCompleteNotification extends JSONRPCNotification implements ServerNotificationInterface
{
    ...
    /**
     * @var \Gravity_Forms\Gravity_Forms\WP\McpSchema\Client\Elicitation\DTO\ElicitationCompleteNotificationParams
     */
    protected ElicitationCompleteNotificationParams $typedParams;

    /**
     * @param '2.0' $jsonrpc @since 2025-11-25
     * @param \Gravity_Forms\Gravity_Forms\WP\McpSchema\Client\Elicitation\DTO\ElicitationCompleteNotificationParams $params @since 2025-11-25
     */
     ...
     *     params: array<string, mixed>|\Gravity_Forms\Gravity_Forms\WP\McpSchema\Client\Elicitation\DTO\ElicitationCompleteNotificationParams
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \Gravity_Forms\Gravity_Forms\WP\McpSchema\Client\Elicitation\DTO\ElicitationCompleteNotificationParams $params */
    ...
    /**
     * @return \Gravity_Forms\Gravity_Forms\WP\McpSchema\Client\Elicitation\DTO\ElicitationCompleteNotificationParams
     */
