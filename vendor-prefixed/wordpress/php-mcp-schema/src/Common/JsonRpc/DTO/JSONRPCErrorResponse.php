...
class JSONRPCErrorResponse extends AbstractDataTransferObject implements JSONRPCResponseInterface
{
     ...
     * @since 2025-11-25
     *
     * @var \Gravity_Forms\Gravity_Forms\WP\McpSchema\Common\JsonRpc\DTO\Error
     */
    protected Error $error;

    /**
     * @param '2.0' $jsonrpc @since 2025-11-25
     * @param \Gravity_Forms\Gravity_Forms\WP\McpSchema\Common\JsonRpc\DTO\Error $error @since 2025-11-25
     ...
     *     error: array<string, mixed>|\Gravity_Forms\Gravity_Forms\WP\McpSchema\Common\JsonRpc\DTO\Error
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \Gravity_Forms\Gravity_Forms\WP\McpSchema\Common\JsonRpc\DTO\Error $error */
