...
use Gravity_Forms\Gravity_Forms\WP\McpSchema\Common\Protocol\DTO\PaginatedRequest;
use Gravity_Forms\Gravity_Forms\WP\McpSchema\Common\Protocol\DTO\PaginatedRequestParams;
...
class ListTasksRequest extends PaginatedRequest implements ClientRequestInterface, ServerRequestInterface
{
     ...
     * @param \Gravity_Forms\Gravity_Forms\WP\McpSchema\Common\Protocol\DTO\PaginatedRequestParams|null $params @since 2025-11-25
     */
     ...
     *
     * @param array{
     *     params?: array<string, mixed>|\Gravity_Forms\Gravity_Forms\WP\McpSchema\Common\Protocol\DTO\PaginatedRequestParams|null,
     *     jsonrpc: '2.0',
     *     id: string|number,
     *     method: 'tasks/list'
     * } $data
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \Gravity_Forms\Gravity_Forms\WP\McpSchema\Common\Protocol\DTO\PaginatedRequestParams|null $params */
