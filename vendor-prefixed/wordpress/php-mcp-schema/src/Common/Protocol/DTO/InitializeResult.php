...
use Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Lifecycle\DTO\ServerCapabilities;
...
class InitializeResult extends Result implements ServerResultInterface
{
     ...
     * @since 2024-11-05
     *
     * @var \Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Lifecycle\DTO\ServerCapabilities
     */
     ...
     * @param \Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Lifecycle\DTO\ServerCapabilities $capabilities @since 2024-11-05
     * @param \Gravity_Forms\Gravity_Forms\WP\McpSchema\Common\Lifecycle\DTO\Implementation $serverInfo @since 2024-11-05
     ...
     *     capabilities: array<string, mixed>|\Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Lifecycle\DTO\ServerCapabilities,
     *     serverInfo: array<string, mixed>|\Gravity_Forms\Gravity_Forms\WP\McpSchema\Common\Lifecycle\DTO\Implementation,
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var \Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Lifecycle\DTO\ServerCapabilities $capabilities */
        $capabilities = is_array($data['capabilities'])
            ? ServerCapabilities::fromArray(self::asArray($data['capabilities']))
            : $data['capabilities'];

        /** @var \Gravity_Forms\Gravity_Forms\WP\McpSchema\Common\Lifecycle\DTO\Implementation $serverInfo */
    ...
    /**
     * @return \Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Lifecycle\DTO\ServerCapabilities
     */
