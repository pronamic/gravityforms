...
use Gravity_Forms\Gravity_Forms\WP\MCP\Domain\Utils\SchemaTransformer;
...
class RegisterAbilityAsMcpPrompt {
	 ...
	 * @param \WP_Ability $ability The ability.
	 *
	 * @return \Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Prompts\DTO\Prompt|\WP_Error Returns Prompt DTO or WP_Error if validation fails.
	 */
	 ...
	 *
	 * @return \Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Prompts\DTO\Prompt|\WP_Error Prompt DTO or WP_Error if validation fails.
	 * @since 0.5.0
	 *
	 */
	 ...
	 *
	 * @return list<\Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Prompts\DTO\PromptArgument>|\WP_Error PromptArgument DTOs or WP_Error.
	 * @since 0.5.0
	 *
	 */
	 ...
	 *
	 * @return list<\Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Prompts\DTO\PromptArgument> Argument DTO list.
	 * @since 0.5.0
	 *
	 */
	 ...
	 * @param \WP_Ability $ability The ability.
	 *
	 * @return array{prompt: \Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Prompts\DTO\Prompt, adapter_meta: array<string, mixed>}|\WP_Error
	 * @since 0.5.0
	 *
	 */
