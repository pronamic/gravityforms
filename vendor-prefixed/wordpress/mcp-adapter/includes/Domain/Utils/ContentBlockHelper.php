 ...
 *
 * @package \Gravity_Forms\Gravity_Forms\WP\MCP\Domain\Utils
 */
declare (strict_types=1);
namespace Gravity_Forms\Gravity_Forms\WP\MCP\Domain\Utils;

use Gravity_Forms\Gravity_Forms\WP\McpSchema\Common\Content\DTO\AudioContent;
use Gravity_Forms\Gravity_Forms\WP\McpSchema\Common\Content\DTO\ImageContent;
use Gravity_Forms\Gravity_Forms\WP\McpSchema\Common\Content\DTO\TextContent;
use Gravity_Forms\Gravity_Forms\WP\McpSchema\Common\Protocol\DTO\Annotations;
use Gravity_Forms\Gravity_Forms\WP\McpSchema\Common\Protocol\DTO\BlobResourceContents;
use Gravity_Forms\Gravity_Forms\WP\McpSchema\Common\Protocol\DTO\EmbeddedResource;
use Gravity_Forms\Gravity_Forms\WP\McpSchema\Common\Protocol\DTO\TextResourceContents;
...
final class ContentBlockHelper
{
     ...
     * @param \Gravity_Forms\Gravity_Forms\WP\McpSchema\Common\Protocol\DTO\Annotations|null $annotations Optional annotations for the client.
     * @param array|null $_meta Optional metadata.
     *
     * @return \Gravity_Forms\Gravity_Forms\WP\McpSchema\Common\Content\DTO\ImageContent The created ImageContent DTO.
     */
    public static function image(string $data, string $mime_type, ?Annotations $annotations = null, ?array $_meta = null): ImageContent
    {
        return ImageContent::fromArray(array('type' => ImageContent::TYPE, 'data' => $data, 'mimeType' => $mime_type, 'annotations' => $annotations, '_meta' => $_meta));
    }
    /**
     ...
     * @param array|null $_meta Optional metadata.
     *
     * @return \Gravity_Forms\Gravity_Forms\WP\McpSchema\Common\Content\DTO\AudioContent The created AudioContent DTO.
     */
    public static function audio(string $data, string $mime_type, ?Annotations $annotations = null, ?array $_meta = null): AudioContent
    {
        return AudioContent::fromArray(array('type' => AudioContent::TYPE, 'data' => $data, 'mimeType' => $mime_type, 'annotations' => $annotations, '_meta' => $_meta));
    }
    /**
     ...
     * @param array|null $_meta Optional metadata.
     *
     * @return \Gravity_Forms\Gravity_Forms\WP\McpSchema\Common\Protocol\DTO\EmbeddedResource The created EmbeddedResource DTO.
     */
    public static function embedded_text_resource(string $uri, string $text, ?string $mime_type = null, ?Annotations $annotations = null, ?array $_meta = null): EmbeddedResource
    {
        $resource = TextResourceContents::fromArray(array('uri' => $uri, 'text' => $text, 'mimeType' => $mime_type));
        return EmbeddedResource::fromArray(array('type' => EmbeddedResource::TYPE, 'resource' => $resource, 'annotations' => $annotations, '_meta' => $_meta));
    }
    /**
     ...
     * @return \Gravity_Forms\Gravity_Forms\WP\McpSchema\Common\Protocol\DTO\EmbeddedResource The created EmbeddedResource DTO.
     */
    public static function embedded_blob_resource(string $uri, string $blob, ?string $mime_type = null, ?Annotations $annotations = null, ?array $_meta = null): EmbeddedResource
    {
        $resource = BlobResourceContents::fromArray(array('uri' => $uri, 'blob' => $blob, 'mimeType' => $mime_type));
        return EmbeddedResource::fromArray(array('type' => EmbeddedResource::TYPE, 'resource' => $resource, 'annotations' => $annotations, '_meta' => $_meta));
    }
    /**
     ...
     * @param array|null $_meta Optional metadata.
     *
     * @return \Gravity_Forms\Gravity_Forms\WP\McpSchema\Common\Content\DTO\TextContent The created TextContent DTO.
     */
    ...
    {
        return TextContent::fromArray(array('type' => TextContent::TYPE, 'text' => $text, 'annotations' => $annotations, '_meta' => $_meta));
    }
    /**
     ...
     *
     * @param \Gravity_Forms\Gravity_Forms\WP\McpSchema\Common\Protocol\Union\ContentBlockInterface[] $blocks Array of content block DTOs.
     *
     * @return array[] Array of content block arrays.
     */
    public static function to_array_list(array $blocks): array
    {
        return array_map(static function (ContentBlockInterface $block): array {
