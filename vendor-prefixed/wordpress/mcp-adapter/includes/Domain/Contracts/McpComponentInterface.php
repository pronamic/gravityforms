...
namespace Gravity_Forms\Gravity_Forms\WP\MCP\Domain\Contracts;
...
interface McpComponentInterface {
	 ...
	 *
	 * @return \Gravity_Forms\Gravity_Forms\WP\McpSchema\Common\AbstractDataTransferObject Protocol-only DTO.
	 * @since 0.5.0
	 *
	 */
