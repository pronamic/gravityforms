...
namespace Gravity_Forms\Gravity_Forms\WP\MCP\Domain\Resources;

use Gravity_Forms\Gravity_Forms\WP\MCP\Domain\Utils\McpAnnotationMapper;
...
class RegisterAbilityAsMcpResource {
	 ...
	 *
	 * @var \Gravity_Forms\Gravity_Forms\WP\MCP\Infrastructure\ErrorHandling\Contracts\McpErrorHandlerInterface|null
	 */
	 ...
	 * @param \Gravity_Forms\Gravity_Forms\WP\MCP\Infrastructure\ErrorHandling\Contracts\McpErrorHandlerInterface|null $error_handler Optional error handler.
	 */
	 ...
	 *
	 * @param \WP_Ability $ability The ability.
	 * @param \Gravity_Forms\Gravity_Forms\WP\MCP\Infrastructure\ErrorHandling\Contracts\McpErrorHandlerInterface|null $error_handler Optional error handler for logging.
	 *
	 * @return \Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Resources\DTO\Resource|\WP_Error Returns Resource DTO or WP_Error if validation fails.
	 */
	 ...
	 *
	 * @return \Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Resources\DTO\Resource|\WP_Error Returns the Resource DTO or WP_Error if validation fails.
	 */
	 ...
	 * @param \Gravity_Forms\Gravity_Forms\WP\MCP\Infrastructure\ErrorHandling\Contracts\McpErrorHandlerInterface|null $error_handler Optional error handler.
	 *
	 * @return array{resource: \Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Resources\DTO\Resource, adapter_meta: array<string, mixed>}|\WP_Error
	 * @since 0.5.0
	 *
	 */
