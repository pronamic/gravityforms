...
namespace Gravity_Forms\Gravity_Forms\WP\MCP\Handlers\Initialize;

use Gravity_Forms\Gravity_Forms\WP\MCP\Core\McpServer;
use Gravity_Forms\Gravity_Forms\WP\MCP\Core\McpVersionNegotiator;
use Gravity_Forms\Gravity_Forms\WP\McpSchema\Common\Lifecycle\DTO\Implementation;
use Gravity_Forms\Gravity_Forms\WP\McpSchema\Common\Protocol\DTO\InitializeResult;
...
class InitializeHandler {
	 ...
	 *
	 * @return \Gravity_Forms\Gravity_Forms\WP\McpSchema\Common\Protocol\DTO\InitializeResult Response with server capabilities and information.
	 */
