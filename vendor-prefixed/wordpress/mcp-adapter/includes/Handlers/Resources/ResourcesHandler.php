...
namespace Gravity_Forms\Gravity_Forms\WP\MCP\Handlers\Resources;

use Gravity_Forms\Gravity_Forms\WP\MCP\Core\McpServer;
use Gravity_Forms\Gravity_Forms\WP\MCP\Handlers\HandlerHelperTrait;
use Gravity_Forms\Gravity_Forms\WP\MCP\Infrastructure\ErrorHandling\McpErrorFactory;
...
use Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Resources\DTO\ListResourceTemplatesResult;
use Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Resources\DTO\ListResourcesResult;
use Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Resources\DTO\ReadResourceResult;
...
class ResourcesHandler {
	 ...
	 * Constructor.
	 *
	 * @param \Gravity_Forms\Gravity_Forms\WP\MCP\Core\McpServer $mcp The WordPress MCP instance.
	 */
	 ...
	 *
	 * @return \Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Resources\DTO\ListResourcesResult Response with resources list.
	 */
	public function list_resources(): ListResourcesResult {
		 ...
		 * @since 0.5.0
		 *
		 * @param array<\Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Resources\DTO\Resource> $resources Array of Resource DTOs.
	 ...
	 *
	 * @return \Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Resources\DTO\ListResourceTemplatesResult Empty resource-templates list.
	 */
	 ...
	 *
	 * @return \Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Resources\DTO\ReadResourceResult|\Gravity_Forms\Gravity_Forms\WP\McpSchema\Common\JsonRpc\DTO\JSONRPCErrorResponse
	 */
	public function read_resource( array $params, $request_id = 0 ) {
		...
		/** @var \Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Resources\DTO\Resource $resource */
	 ...
	 * @param string $uri The resource URI.
	 *
	 * @return array<\Gravity_Forms\Gravity_Forms\WP\McpSchema\Common\Protocol\DTO\TextResourceContents|\Gravity_Forms\Gravity_Forms\WP\McpSchema\Common\Protocol\DTO\BlobResourceContents>
	 */
	 ...
	 *
	 * @return \Gravity_Forms\Gravity_Forms\WP\McpSchema\Common\Protocol\DTO\TextResourceContents|\Gravity_Forms\Gravity_Forms\WP\McpSchema\Common\Protocol\DTO\BlobResourceContents
	 */
