...
namespace Gravity_Forms\Gravity_Forms\WP\MCP\Handlers\Tools;

use Gravity_Forms\Gravity_Forms\WP\MCP\Core\McpServer;
use Gravity_Forms\Gravity_Forms\WP\MCP\Domain\Utils\ContentBlockHelper;
...
use Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Tools\DTO\CallToolResult;
use Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Tools\DTO\ListToolsResult;
...
class ToolsHandler {
	 ...
	 *
	 * @return \Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Tools\DTO\ListToolsResult Response with all tools.
	 */
	 ...
	 * to MCP clients.
	 *
	 * @return \Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Tools\DTO\ListToolsResult Response with tools list.
	 */
	public function list_tools(): ListToolsResult {
		 ...
		 * @since 0.5.0
		 *
		 * @param array<\Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Tools\DTO\Tool> $tools  Array of Tool DTOs.
	 ...
	 *
	 * @return \Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Tools\DTO\CallToolResult|\Gravity_Forms\Gravity_Forms\WP\McpSchema\Common\JsonRpc\DTO\JSONRPCErrorResponse
	 */
	 ...
	 *
	 * @return \Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Tools\DTO\CallToolResult
	 */
