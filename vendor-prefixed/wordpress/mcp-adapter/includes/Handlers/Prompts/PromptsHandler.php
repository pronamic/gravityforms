...
namespace Gravity_Forms\Gravity_Forms\WP\MCP\Handlers\Prompts;
...
use Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Prompts\DTO\GetPromptResult;
use Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Prompts\DTO\ListPromptsResult;
use Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Prompts\DTO\Prompt as PromptDto;
use Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Prompts\DTO\PromptMessage;
...
class PromptsHandler {
	 ...
	 *
	 * @return \Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Prompts\DTO\ListPromptsResult Response with prompts list DTO.
	 */
	public function list_prompts(): ListPromptsResult {
		 ...
		 * @since 0.5.0
		 *
		 * @param array<\Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Prompts\DTO\Prompt> $prompts Array of Prompt DTOs.
	 ...
	 *
	 * @return \Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Prompts\DTO\GetPromptResult|\Gravity_Forms\Gravity_Forms\WP\McpSchema\Common\JsonRpc\DTO\JSONRPCErrorResponse Response with prompt execution results or error.
	 */
	 ...
	 * @param \Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Prompts\DTO\Prompt $prompt      The prompt DTO for description fallback.
	 * @param string                                $prompt_name Prompt name for logging.
	 *
	 * @return \Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Prompts\DTO\GetPromptResult
	 */
	 ...
	 * @param \Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Prompts\DTO\Prompt $prompt      The prompt DTO.
	 * @param string                                $prompt_name Prompt name for logging.
	 *
	 * @return \Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Prompts\DTO\GetPromptResult
	 */
	 ...
	 * @param string $prompt_name Prompt name for logging.
	 *
	 * @return \Gravity_Forms\Gravity_Forms\WP\McpSchema\Server\Prompts\DTO\PromptMessage
	 */
