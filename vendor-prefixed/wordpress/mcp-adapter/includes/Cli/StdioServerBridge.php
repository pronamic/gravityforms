...
namespace Gravity_Forms\Gravity_Forms\WP\MCP\Cli;
...
use Gravity_Forms\Gravity_Forms\WP\MCP\Transport\Infrastructure\JsonRpcResponseBuilder;
use Gravity_Forms\Gravity_Forms\WP\MCP\Transport\Infrastructure\RequestRouter;
...
class StdioServerBridge {
	 ...
	 *
	 * @var \Gravity_Forms\Gravity_Forms\WP\MCP\Transport\Infrastructure\RequestRouter
	 */
	 ...
	 *
	 * @param \Gravity_Forms\Gravity_Forms\WP\MCP\Core\McpServer $server The MCP server to expose.
	 */
	 ...
	 *
	 * @return \Gravity_Forms\Gravity_Forms\WP\MCP\Transport\Infrastructure\RequestRouter
	 */
