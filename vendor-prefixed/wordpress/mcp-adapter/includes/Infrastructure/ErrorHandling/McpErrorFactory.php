...
namespace Gravity_Forms\Gravity_Forms\WP\MCP\Infrastructure\ErrorHandling;

use Gravity_Forms\Gravity_Forms\WP\McpSchema\Common\JsonRpc\DTO\Error;
use Gravity_Forms\Gravity_Forms\WP\McpSchema\Common\JsonRpc\DTO\JSONRPCErrorResponse;
use Gravity_Forms\Gravity_Forms\WP\McpSchema\Common\McpConstants;
...
class McpErrorFactory {
	 ...
	 * @param mixed|null $data Optional additional error data.
	 *
	 * @return \Gravity_Forms\Gravity_Forms\WP\McpSchema\Common\JsonRpc\DTO\Error
	 */
	 ...
	 *
	 * @param \Gravity_Forms\Gravity_Forms\WP\McpSchema\Common\JsonRpc\DTO\JSONRPCErrorResponse|array $error_response The MCP error response (DTO or array).
	 *
	 ...
	 *
	 * @return true|\Gravity_Forms\Gravity_Forms\WP\McpSchema\Common\JsonRpc\DTO\JSONRPCErrorResponse Returns true if valid, or JSONRPCErrorResponse DTO if invalid.
	 */
