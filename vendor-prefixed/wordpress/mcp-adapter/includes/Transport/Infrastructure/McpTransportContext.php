...
namespace Gravity_Forms\Gravity_Forms\WP\MCP\Transport\Infrastructure;

use Gravity_Forms\Gravity_Forms\WP\MCP\Core\McpServer;
use Gravity_Forms\Gravity_Forms\WP\MCP\Handlers\Initialize\InitializeHandler;
use Gravity_Forms\Gravity_Forms\WP\MCP\Handlers\Prompts\PromptsHandler;
use Gravity_Forms\Gravity_Forms\WP\MCP\Handlers\Resources\ResourcesHandler;
use Gravity_Forms\Gravity_Forms\WP\MCP\Handlers\System\SystemHandler;
use Gravity_Forms\Gravity_Forms\WP\MCP\Handlers\Tools\ToolsHandler;
...
class McpTransportContext {
	 ...
	 *
	 * @var \Gravity_Forms\Gravity_Forms\WP\MCP\Handlers\Initialize\InitializeHandler
	 */
	 ...
	 * The tools handler.
	 *
	 * @var \Gravity_Forms\Gravity_Forms\WP\MCP\Handlers\Tools\ToolsHandler
	 */
	 ...
	 *
	 * @var \Gravity_Forms\Gravity_Forms\WP\MCP\Handlers\Resources\ResourcesHandler
	 */
	 ...
	 * The prompts handler.
	 *
	 * @var \Gravity_Forms\Gravity_Forms\WP\MCP\Handlers\Prompts\PromptsHandler
	 */
	 ...
	 * The system handler.
	 *
	 * @var \Gravity_Forms\Gravity_Forms\WP\MCP\Handlers\System\SystemHandler
	 */
	 ...
	 *
	 * @param array{
	 *   mcp_server: \Gravity_Forms\Gravity_Forms\WP\MCP\Core\McpServer,
	 *   initialize_handler: \Gravity_Forms\Gravity_Forms\WP\MCP\Handlers\Initialize\InitializeHandler,
	 *   tools_handler: \Gravity_Forms\Gravity_Forms\WP\MCP\Handlers\Tools\ToolsHandler,
	 *   resources_handler: \Gravity_Forms\Gravity_Forms\WP\MCP\Handlers\Resources\ResourcesHandler,
	 *   prompts_handler: \Gravity_Forms\Gravity_Forms\WP\MCP\Handlers\Prompts\PromptsHandler,
	 *   system_handler: \Gravity_Forms\Gravity_Forms\WP\MCP\Handlers\System\SystemHandler,
	 *   observability_handler: \Gravity_Forms\Gravity_Forms\WP\MCP\Infrastructure\Observability\Contracts\McpObservabilityHandlerInterface,
	 *   request_router?: \Gravity_Forms\Gravity_Forms\WP\MCP\Transport\Infrastructure\RequestRouter,
	 *   transport_permission_callback?: callable|null,
	 *   error_handler?: \Gravity_Forms\Gravity_Forms\WP\MCP\Infrastructure\ErrorHandling\Contracts\McpErrorHandlerInterface
