...
use Gravity_Forms\Gravity_Forms\WP\MCP\Infrastructure\ErrorHandling\ErrorLogMcpErrorHandler;
use WP_Error;
...
final class SessionManager {
	 ...
	 * @param \Gravity_Forms\Gravity_Forms\WP\MCP\Infrastructure\ErrorHandling\Contracts\McpErrorHandlerInterface|null $error_handler Error handler for reporting storage failures. Defaults to the standard error-log handler.
	 *
