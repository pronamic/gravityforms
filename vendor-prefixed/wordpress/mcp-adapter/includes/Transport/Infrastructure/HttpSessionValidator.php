...
class HttpSessionValidator {
	 ...
	 *
	 * @param \Gravity_Forms\Gravity_Forms\WP\MCP\Transport\Infrastructure\HttpRequestContext                  $context       The HTTP request context.
	 * @param \Gravity_Forms\Gravity_Forms\WP\MCP\Infrastructure\ErrorHandling\Contracts\McpErrorHandlerInterface|null $error_handler Error handler for reporting storage failures.
	 *
	 * @return array|true Returns true if valid, error array if invalid.
	 */
