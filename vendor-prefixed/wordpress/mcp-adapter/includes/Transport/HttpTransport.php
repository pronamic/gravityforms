...
namespace Gravity_Forms\Gravity_Forms\WP\MCP\Transport;

use Gravity_Forms\Gravity_Forms\WP\MCP\Transport\Contracts\McpRestTransportInterface;
use Gravity_Forms\Gravity_Forms\WP\MCP\Transport\Infrastructure\HttpRequestContext;
use Gravity_Forms\Gravity_Forms\WP\MCP\Transport\Infrastructure\HttpRequestHandler;
use Gravity_Forms\Gravity_Forms\WP\MCP\Transport\Infrastructure\McpTransportContext;
use Gravity_Forms\Gravity_Forms\WP\MCP\Transport\Infrastructure\McpTransportHelperTrait;
...
class HttpTransport implements McpRestTransportInterface {
	 ...
	 *
	 * @var \Gravity_Forms\Gravity_Forms\WP\MCP\Transport\Infrastructure\HttpRequestHandler
	 */
	 ...
	 *
	 * @param \Gravity_Forms\Gravity_Forms\WP\MCP\Transport\Infrastructure\McpTransportContext $transport_context The transport context.
	 */
