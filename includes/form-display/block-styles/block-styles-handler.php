...
class Block_Styles_Handler {
	...
	public function form_css_properties( $form_id, $settings, $block_settings ) {
		...
		return array(
			...
			'gform-theme-color-primary-lighter'      => $color_palette['primary']['color-lighter'],
			...
			'gform-theme-color-secondary-darker'       => $color_palette['secondary']['color-darker'],
			'gform-theme-color-secondary-lighter'      => $color_palette['secondary']['color-lighter'],

			'gform-theme-color-outside-control-light'         => $color_palette['outside-control-light']['color'],
			'gform-theme-color-outside-control-light-rgb'     => implode( ', ', $color_palette['outside-control-light']['color-rgb'] ),
			'gform-theme-color-outside-control-light-darker'  => $color_palette['outside-control-light']['color-darker'],
			'gform-theme-color-outside-control-light-lighter' => $color_palette['outside-control-light']['color-lighter'],

			'gform-theme-color-outside-control-dark'         => $color_palette['outside-control-dark']['color'],
			'gform-theme-color-outside-control-dark-rgb'     => implode( ', ', $color_palette['outside-control-dark']['color-rgb'] ),
			'gform-theme-color-outside-control-dark-darker'  => $color_palette['outside-control-dark']['color-darker'],
			'gform-theme-color-outside-control-dark-lighter' => $color_palette['outside-control-dark']['color-lighter'],

			'gform-theme-color-inside-control'              => $color_palette['inside-control']['color'],
			'gform-theme-color-inside-control-rgb'          => implode( ', ', $color_palette['inside-control']['color-rgb'] ),
			'gform-theme-color-inside-control-contrast'     => $color_palette['inside-control']['color-contrast'],
			...
			'gform-theme-color-inside-control-light-lighter' => $color_palette['inside-control-light']['color-lighter'],

			'gform-theme-color-inside-control-dark'         => $color_palette['inside-control-dark']['color'],
			'gform-theme-color-inside-control-dark-rgb'     => implode( ', ', $color_palette['inside-control-dark']['color-rgb'] ),
			'gform-theme-color-inside-control-dark-darker'  => $color_palette['inside-control-dark']['color-darker'],
			'gform-theme-color-inside-control-dark-lighter' => $color_palette['inside-control-dark']['color-lighter'],
			...
			'gform-theme-icon-control-select' => "url(\"data:image/svg+xml,%3Csvg width='10' height='6' viewBox='0 0 10 6' fill='none' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath fill-rule='evenodd' clip-rule='evenodd' d='M0.292893 0.292893C0.683417 -0.097631 1.31658 -0.097631 1.70711 0.292893L5 3.58579L8.29289 0.292893C8.68342 -0.0976311 9.31658 -0.0976311 9.70711 0.292893C10.0976 0.683417 10.0976 1.31658 9.70711 1.70711L5.70711 5.70711C5.31658 6.09763 4.68342 6.09763 4.29289 5.70711L0.292893 1.70711C-0.0976311 1.31658 -0.0976311 0.683418 0.292893 0.292893Z' fill='{$color_palette['inside-control-dark']['color-lighter']}'/%3E%3C/svg%3E\")",
